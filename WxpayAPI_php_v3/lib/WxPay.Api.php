...
class WxPayApi
{
	...
	{		
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERTTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLCERT, C('WWW_ROOT').'/WxpayAPI_php_v3/cert/apiclient_cert.pem');
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, C('WWW_ROOT').'/WxpayAPI_php_v3/cert/apiclient_key.pem');
		}
		//post提交方式
