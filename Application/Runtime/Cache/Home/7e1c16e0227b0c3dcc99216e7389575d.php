			...
			var addComp = data.result,
				...
				var html='<h2><img src="/Public/image/positio_icon.png" alt=""><span class="default_city">'+cityName+regionName+streetnName+'</span></h2>'
						...
						for(var i=0, len=addComp.pois.length; i<len; i++){
							...
							html+='<li><a href="/Address/edit.html?district='+arr.name+'&x='+k+'&y='+s+'&cityCode='+cityCode+'&cityname='+cityName+'&address_id='+address_id+'&address='+address+'&name='+name+'&mobile='+mobile+'">'
									+'<h3>'+arr.name+'</h3>'
									+'<p>'+arr.addr+'</p>'
									+'</a></li>'
						}
