...
<body>
	<div class="wrap_log">
		<form id="autocomplete-form" class="mod-order-common login-form" onsubmit="return false;"  action="/ActivityTwo/xiangqing">
			...
			var btn = $('#btn2');
				...
				btn.on('tap',function(){
					...
					// loaging.init('加载中，请稍后...');
						...
						$.ajax({
							url: '/ActivityTwo/get_is_one_yuan',
							type: 'POST',
							data: {phone: phones},
							success:function(rs){
								...
								}else if(re.result == "er_ok"){
									loaging.init('加载中，请稍后...');
									window.location.href="http://weixin.hahajing.com/ActivityTwo/fenxiang/pid/"+re.pid;
								}else{
