...
<body class="mod-addredit-add">
    <div id="mod-container" class="mod-container clearfix">
        <div id="mod-addredit" class="mod-addredit pageview">
            <form id="autocomplete-form" method="post" action="/Address/add" >
            <header class="pub-header bgss">
                <a class="tap-action icon icon-back" href="javascript:history.go(-1);">
                </a>
    ...
    $(document).ready(function() { 
        ...
        function clicks(){
            ...
            $('.LogBtn').on(tapClick(),function(){
                ...
                location.href='/Address/location.html?cityName='+cityName+'&address_id='+address_id+'&address='+address+'&name='+name+'&mobile='+mobile;
            })
            ...
            seabtn.on(tapClick(),function(){           
                ...
                var name=$name.val();
                var mobile=$auto_phone.val();
                location.href='/Address/custom.html?cityName='+cityName+'&cityCode='+cityCode+'&address_id='+address_id+'&address='+address+'&name='+name+'&mobile='+mobile;
            })  
            //点击删除
