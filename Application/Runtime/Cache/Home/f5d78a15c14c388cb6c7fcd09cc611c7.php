...
<head>
	...
	<link rel="stylesheet" href="/Public/css/set.css"><style type="text/css">.flex_span1{margin-right: 5px;}</style>
</head>
<body>
			...
			<article class="wrap_co_div wrap_coDel">
				<section class="co_div">
					<div class="coDiv_dis flex flexsJusi" id="co_del">
						...
						<p class="dis_r">
							<a href="/ActivityTwo/set_address_add?ticket_list_ids=<?php echo ($ticket_list_ids); ?>&cart_ids=<?php echo ($cart_ids); ?>">
				...
				<section class="co_div co_divs2">
					<div class="coDiv_dis coDiv_times flex flexsJusi" id="coDiv_times">
						...
						<p class="dis_r dis_p" id="timer_right"><img src="/Public/image/active/d_size.png" alt=""><!-- <span class="dis_rspan">2016-10-10 10:10:10</span> --></p>
					</div>
					<div class="coDiv_del">
						<p class="del_l dis_p">配送费10元 10:00-22:00至此配送</p>
					</div>
				</section>
			</article>
			<article class="wrap_co_div wrap_co_div2">
				...
				<section class="co_div generals">
			        ...
			        <ul class="generals_menu">
			            ...
			            <li class="clist_lis flex">
			                <p class="cy_name flexs flexsJusi">配送费</p>
			                <span class="cy_price blocks">￥<?php echo ($data['post_fee']); ?></span>
			            </li>
			            <li class="clist_lis flex">
				...
				<div class="co_hideSec2">
					<div class="co_divs">
		                <div class="co_divs1 co_hib">
		                	<a href="javascript:;">
		                		<span class="p_green"><?php echo ($xianshi_data['hou_time']); ?></span>
		                		<span><?php echo ($xianshi_data['dahouhou_time']); ?></span>
		                	</a>
		                </div>
		               <p class="co_divs2 co_hib p_green"><?php echo ($xianshi_data['hou_time']); ?></p>
		            </div>
		            <ul class="co_menus">
...
<script src="/Public/js/lib/all.js" type="text/javascript" charset="utf-8"></script>
	<script type="text/javascript">
		...
		var co_del = $('#co_del'),
			...
			// co_del.on('click',function(){
			// 	loaging.close();
			// 	//loaging.init('加载中，请稍后...');
			// 	window.location.href="/ActivityTwo/set_address_add";
			// });
	    ...
	    goods_submit.on(tapClick(),function(){
	            ...
	            var address_id = $('#address_id').val(),
                  ...
                  var option = {
	                ...
	                commoms.post_servers('/ActivityTwo/add',option,function(re){
	                	console.log(re);
	                    if(re.result=='ok') {
